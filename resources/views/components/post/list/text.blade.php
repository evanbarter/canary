<div x-on:click="view({{ $post->id }})" class="flex flex-col p-4 h-64 rounded-lg shadow-lg text-gray-700 bg-white hover:bg-gray-50 hover:text-gray-900 dark-mode:bg-gray-800 dark-mode:hover:bg-gray-900 dark-mode:text-gray-200 dark-mode:hover:text-gray-400 cursor-pointer">
