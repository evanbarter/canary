<div x-data="post()">
    ...
    <div class="fixed z-50 inset-0 px-4 m-8 sm:m-12 flex items-center justify-center">
        ...
        <div class="flex flex-col min-h-full max-h-11/12 w-full sm:max-w-4xl z-50">
            <div class="flex">
                <h1 id="modal-headline" class="flex-1 mb-4 font-serif font-bold italic text-xl sm:text-3xl leading-tight text-white shadow-sm dark-mode:text-gray-400">{{ $post->postable->title }}</h1>
