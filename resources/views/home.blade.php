...
@section('content')
    ...
    <div class="fixed bottom-0 inset-x-auto flex justify-between items-center h-16 w-full px-8 bg-white dark-mode:bg-gray-900 shadow-inner">
        <div class="flex-1">
            ...
            <a class="border-b-2 border-gray-400 text-gray-400 uppercase text-sm font-medium mr-3 @if(request()->is('feed*')) border-gray-700 text-gray-700 @else border-gray-400 text-gray-400 hover:text-gray-500 @endif" href="{{ route('feed') }}">{{ __('Feed') }}</a>
        </div>
            ...
            <div
                ...
                <div @click="open = !open" class="rounded-md bg-white dark-mode:bg-gray-800 shadow-xs">
                    <div class="py-1" role="menu" aria-orientation="vertical" aria-labelledby="options-menu" x-data="{}" x-subscribe x-cloak>
                        <a href="#" @click="$store.postModal.open = 'image'" class="block px-4 py-2 text-xs sm:text-sm leading-5 text-gray-700 hover:bg-gray-100 hover:text-gray-900 focus:outline-none focus:bg-gray-100 focus:text-gray-900 dark-mode:text-white dark-mode:hover:bg-gray-600 dark-mode:hover:text-gray-200" role="menuitem">
                        ...
                        <a href="#" @click="$store.postModal.open = 'text'" class="block px-4 py-2 text-xs sm:text-sm leading-5 text-gray-700 hover:bg-gray-100 hover:text-gray-900 focus:outline-none focus:bg-gray-100 focus:text-gray-900 dark-mode:text-white dark-mode:hover:bg-gray-600 dark-mode:hover:text-gray-200" role="menuitem">
        ...
        <div class="flex-1">
            <a href="{{ route('settings') }}" class="float-right p-2 rounded-lg hover:bg-gray-100 dark-mode:hover:bg-gray-800 active:bg-gray-200 dark-mode:active:bg-gray-700 focus:outline-none">
                <svg class="h-6 w-6 text-gray-900 dark-mode:text-gray-400 dark-mode:hover:text-gray-200" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor">
